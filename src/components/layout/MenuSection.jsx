		...
		<div className={`flex flex-col gap-3 w-full max-w-full ${className || ""}`}>
			{menuItems.map((item) => (
				<button
					...
					className="w-full max-w-full py-4 px-6 border-2 border-transparent bg-gradient-to-r from-[#DC2366] to-[#4F5CAA] bg-clip-border rounded-xl text-transparent bg-clip-text font-semibold bg-white hover:bg-gray-50 transition-colors text-left relative overflow-hidden"
					style={{
