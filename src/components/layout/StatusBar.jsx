...
export const StatusBar = ({ className }) => {
  return (
    <header className={`flex w-full items-stretch justify-between ${className || ''}`} role="banner">
      <img
      ...
      />
      <div className="flex items-center gap-1" role="group" aria-label="Status indicators">
        <img
        ...
        <img
          ...
          alt="WiFi connection"
          className="aspect-[1.14] object-contain w-4"
        />
        <img
          ...
          alt="Battery level"
          className="aspect-[2.08] object-contain w-[25px]"
        />
      </div>
    </header>
  );
